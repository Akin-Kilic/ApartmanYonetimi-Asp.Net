<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="UpdateInformationManager.aspx.cs" Inherits="web_tasarim_ve_programlama.ApartmanIslemleri.UpdateInformationManager" %>
    ...
    <div class="container">
        <asp:DataList ID="DataList1" runat="server">
            <ItemTemplate>
                ...
                <div class="form-group">
                    <asp:Button CssClass="btn-update-manager" ID="btnGuncelle" runat="server" OnClick="btnGuncelle_Click" Text="Güncelle" />
